...
highlight Normal        cterm=NONE ctermfg=black ctermbg=white gui=NONE guifg=#000 guibg=#fffff0
highlight NonText       ctermfg=black ctermbg=white guifg=black
highlight LineNr        cterm=italic ctermfg=black ctermbg=white gui=italic guifg=black guibg=#ffeedd

" Syntax highlighting scheme
highlight Comment       cterm=italic ctermfg=black ctermbg=white gui=italic guifg=black guibg=white

highlight Constant      ctermfg=black ctermbg=white guifg=black guibg=#ddeeff
"highlight String        ctermfg=black ctermbg=white guifg=black guibg=#ddeeff
...
highlight Statement     ctermfg=black ctermbg=white guifg=black gui=bold
...
highlight VertSplit     cterm=bold ctermfg=black ctermbg=white gui=bold guifg=#ccffcc guibg=#ccffcc
highlight StatusLine     cterm=bold ctermfg=black ctermbg=white gui=bold guifg=#ccffcc guibg=#ccffcc
highlight StatusLineNC     cterm=bold ctermfg=black ctermbg=white gui=bold guifg=#ccffcc guibg=#ccffcc
...
highlight Special       cterm=italic ctermfg=black ctermbg=white gui=italic guifg=black
" SpecialChar defaults to Special
" Tag defaults to Special
" Delimiter defaults to Special
highlight SpecialComment cterm=italic ctermfg=black ctermbg=white gui=italic guifg=black
