...
hi Comment	        guibg=#eeeeee		guifg=#888786	gui=italic
hi PerlPOD	        guibg=white 	guifg=#B86A18	gui=NONE
" dark green 006e26
"hi Constant	        guibg=white		guifg=#006e26	gui=bold
hi Constant	        guibg=white		guifg=black	gui=italic
...
hi Statement 	    guibg=white 	guifg=black	gui=bold
...
hi Function	        guibg=white 	guifg=black	gui=NONE
hi Repeat	        guibg=white 	guifg=black	gui=bold
"$='"[
...
hi Todo		        guibg=yellow guifg=black		term=standout gui=bold
...
hi Conditional		guibg=white 	guifg=black	gui=bold
